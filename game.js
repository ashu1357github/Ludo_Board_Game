...
function winner(pl){
    if(pl==='r'){
        if(totalpr===0){
            ...
            playerroom[0].innerHTML="<img src='winner"+winno+".png' class='crown'>";
            pmove=7;
            moves[0]=0;
            diceRotation(0);
        }
    ...
    if(pl==='g'){
        if(totalpg===0){
            ...
            playerroom[1].innerHTML="<img src='winner"+winno+".png' class='crown'>";
             moves[1]=0;
            pmove=7;
            diceRotation(1);
        }
    ...
    if(pl==='b'){
        if(totalpb===0){
            ...
            playerroom[2].innerHTML="<img src='winner"+winno+".png' class='crown'>";
             moves[3]=0;
            pmove=7;
            diceRotation(3);
        }
    ...
    if(pl==='y'){
        if(totalpy===0){
            ...
            playerroom[3].innerHTML="<img src='winner"+winno+".png' class='crown'>";
             moves[2]=0;
            pmove=7;
            diceRotation(2);
        }
